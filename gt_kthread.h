...
typedef struct __kthread_context
{
     ...
     unsigned int counter; /* for replenshing*/
...
typedef struct __ksched_shared_info
{
     ...
     unsigned short last_cpu; /* Target cpu for next uthread*/
     ...
     gt_spinlock_t ksched_load_balance_lock; /*global lock to serialize load balancing of run queues*/
